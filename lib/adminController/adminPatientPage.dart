...
class _AllPatientsPageState extends State<AllPatientsPage> {
  ...
  late AdminPageProvider adminprovider;
  ...
  void initState() {
    super.initState();
    adminprovider = context.read<AdminPageProvider>();
          ...
          builder: (context, adminprovider, child) {
            ...
            child: Column(
              children: [
                ...
                Expanded(child: _buildMainContent(adminprovider)),
              ],
            ),
          );
          },
  ...
  Widget _buildMainContent(AdminPageProvider adminprovider) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        if (index < adminprovider.allpatients.length) {
          ...
          //     context: context,
          //     builder: (context) {
          //       return item["createdByAdmin"] == null
          //           ? ViewModel(
          //               name: item['name'],
          ...
          //               adminame: "",
          //               // createdbydoctor: "",
          //               createdbydoctor: item['doctor']['name'] ,
          ...
          //               adminuserid:adminprovider.admindetailedprofile.first["userid"] ?? "",
          //               doctoruserid: '',
          //               createdbydoctor: "",
          ...
          onView: () {
            showDialog(
              ...
              builder: (context) {
                final isCreatedByAdmin = item["createdByAdmin"] != null;
                final isCreatedByDoctor = item["createdByDoctor"] != null;
          
                if (isCreatedByDoctor && item["doctor"] != null) {
                  // Created by doctor
                  return ViewModel(
                    name: item['name'],
                    patientid: item['patientId'],
...
class PatientModel extends StatelessWidget {
  ...
  const PatientModel({
    ...
    required this.onVisitTap, required this.isCreatedByAdmin,
  });
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          color: Colors.white,),
                          label: const Text("Visits",style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                          ),),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: status
              ? const [Color(0xFFF0FDF4), Color.fromARGB(255, 135, 253, 174)]
              : [Colors.red.shade100, Colors.red.shade200],
        ),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: status?Color.fromARGB(255, 121, 248, 168):Colors.red.shade200
        )
      ),
      child: Text(
              ...
              children: [
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: viewonTap, child: const Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                    Text("View",
                    style: TextStyle(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  /// Created By (Doctor / Admin)
                  _highlightTile(
                    icon: Icons.person_outline,
                    label: createdbyadmin.isEmpty
                        ? "CREATED BY DOCTOR"
                        : "CREATED BY ADMIN",
                    value: createdbyadmin.isEmpty
                        ? createdbydoctor
                        : adminame,
                  ),
        ...
        children: [
         Text(""),
          _GradientActionButton(
            ...
            text: "Register",
            onTap: () => context.router.push(RegisterNewPatientRoute()),
          ),
        ],
      ),
    );
