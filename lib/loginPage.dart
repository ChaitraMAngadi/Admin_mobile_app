...
class _LoginPageState extends State<LoginPage> {
  ...
  late Future loginphone;
  bool _obscureText = true;
  bool _isLoggingIn = false; // 👈 lock flag to stop double-tap / multiple OTPs
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FilledButton(
                                  ...
                                  onPressed: _isLoggingIn // 👈 disable on 2nd tap while call is in-flight
                                      ? null
                                      : () async {
                                          if (loginformkey.currentState!.validate()) {
                                            final inputemailText = emailController.text
                                                .trim()
                                                .toLowerCase();
                                            final passwordText =
                                                passwordController.text;
                                            ...
                                            setState(() {
                                              _isLoggingIn = true; // 👈 lock immediately
                                            });
                                            ...
                                            try {
                                              ...
                                              // ✅ unlock only if still on this page
                                              // (if navigation happened, page is gone anyway)
                                              if (mounted) {
                                                setState(() {
                                                  _isLoggingIn = false;
                                                });
